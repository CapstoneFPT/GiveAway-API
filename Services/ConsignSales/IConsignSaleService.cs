...
namespace Services.ConsignSales
{
    public interface IConsignSaleService
    {
        ...
        Task<Result<ConsignSaleResponse>> ConfirmReceivedFromShop(Guid consignId, ConsignSaleStatus status);
        ...
        Task<Result<ConsignSaleDetailResponse>> UpdateConsignSaleDetailForApprove(ConfirmReceivedConsignRequest request);
    }
}
