...
namespace WebApi2._0.Infrastructure.Persistence.Migrations.Migrations
{
    ...
    [Migration("20240831074320_UpdateConsignSaleAndConsignSaleLineItem")]
    partial class UpdateConsignSaleAndConsignSaleLineItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusinessObjects.Entities.Feedback", b =>
                {
                    b.HasOne("BusinessObjects.Entities.OrderLineItem", "OrderLineItem")
                        .WithOne("Feedback")
                        .HasForeignKey("BusinessObjects.Entities.Feedback", "OrderLineItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
